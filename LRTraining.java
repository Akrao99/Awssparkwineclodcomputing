...
public class LRTraining {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LogisticRegression svmClassifier = new LogisticRegression()
                .setLabelCol("quality")
                .setFeaturesCol("features");
        LogisticRegressionModel trainedSvmModel = svmClassifier.fit(trainingData);
        ...
        // Save the model
        trainedSvmModel.write().overwrite().save("file:///home/ec2-user/logistic_regression");
    }
}